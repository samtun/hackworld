...
void main() {
	...
	gl_FragColor = pack2HalfToRGBA( vec2( mean, std_dev ) );
            ...
            `,blending:Rr,depthWrite:!1,transparent:!0});this.particles=new pa(a,c),e.add(this.particles)}resetParticle(e,t=!1){const n=this.mesh.position,i=Math.random()*Math.PI*2;this.particleSystem.angles[e]=i;const s=this.RING_RADIUS+(Math.random()-.5)*.1;this.particleSystem.radii[e]=s;const r=e*3;this.particleSystem.positions[r]=n.x+Math.cos(i)*s,this.particleSystem.positions[r+1]=n.y,this.particleSystem.positions[r+2]=n.z+Math.sin(i)*s,t?this.particleSystem.lifetimes[e]=Math.random()*this.PARTICLE_LIFETIME:this.particleSystem.lifetimes[e]=this.PARTICLE_LIFETIME*(.95+Math.random()*.1),this.particleSystem.sizes[e]=this.MAX_PARTICLE_SIZE}update(e){const t=Math.min(e,.1);this.time+=t;const n=this.mesh.position;for(let r=0;r<this.PARTICLE_COUNT;r++){const a=r*3;if(this.particleSystem.lifetimes[r]-=t,this.particleSystem.lifetimes[r]<=0){this.resetParticle(r);continue}const c=1-this.particleSystem.lifetimes[r]/this.PARTICLE_LIFETIME;this.particleSystem.angles[r]+=this.SPIN_SPEED*t;const l=this.particleSystem.angles[r],h=this.particleSystem.radii[r]*(1+c*.8),u=Math.sin(this.time*3+r*.5)*this.TURBULENCE_STRENGTH*c,d=Math.cos(this.time*3+r*.7)*this.TURBULENCE_STRENGTH*c;this.particleSystem.positions[a]=n.x+Math.cos(l)*h+u,this.particleSystem.positions[a+1]=n.y+c*this.RISE_SPEED*this.PARTICLE_LIFETIME,this.particleSystem.positions[a+2]=n.z+Math.sin(l)*h+d,this.particleSystem.sizes[r]=this.MAX_PARTICLE_SIZE*(1-c)}const i=this.particles.geometry.getAttribute("position");i.needsUpdate=!0;const s=this.particles.geometry.getAttribute("size");s&&(s.needsUpdate=!0)}cleanup(e){e.remove(this.mesh),e.remove(this.particles),this.mesh.geometry&&this.mesh.geometry.dispose();const t=this.mesh.material;t&&t.dispose(),this.particles.geometry&&this.particles.geometry.dispose();const n=this.particles.material;n&&n.dispose()}}class Ea{constructor(e,t,n){b(this,"scene");b(this,"physicsWorld");b(this,"physicsMaterial");b(this,"assetManager");b(this,"portal");b(this,"bodies",[]);b(this,"meshes",[]);b(this,"enemies",[]);b(this,"mixers",[]);this.scene=e,this.physicsWorld=t,this.physicsMaterial=n,this.assetManager=zs.getInstance()}static getMetadata(){throw new Error("getMetadata() must be implemented in derived class")}clear(){for(const e of this.mixers)e.stopAllAction();this.mixers=[];for(const e of this.enemies)this.scene.remove(e.mesh),this.physicsWorld.removeBody(e.body);this.enemies=[];for(const e of this.bodies)this.physicsWorld.removeBody(e);this.bodies=[];for(const e of this.meshes){this.scene.remove(e);const t=e;t.geometry&&t.geometry.dispose(),t.material&&(Array.isArray(t.material)?t.material.forEach(n=>n.dispose()):t.material.dispose())}this.meshes=[],this.portal&&(this.portal.cleanup(this.scene),this.portal=void 0)}createBox(e,t,n,i){const s=new Bt(e,t,n),r=new Xt({color:5592405}),a=new Ke(s,r);a.position.copy(i),a.castShadow=!0,a.receiveShadow=!0,this.scene.add(a),this.meshes.push(a);const c=new Lt(new y(e/2,t/2,n/2)),l=new le({mass:0,material:this.physicsMaterial});l.addShape(c),l.position.copy(i),this.physicsWorld.addBody(l),this.bodies.push(l)}createFloor(e,t){const n=new us(e,e),i=new Xt({color:t}),s=new Ke(n,i);s.rotation.x=-Math.PI/2,s.receiveShadow=!0,this.scene.add(s),this.meshes.push(s);const r=new mx,a=new le({mass:0,material:this.physicsMaterial});a.addShape(r),a.quaternion.setFromEuler(-Math.PI/2,0,0),this.physicsWorld.addBody(a),this.bodies.push(a)}createPortal(e,t,n){this.portal=new My(this.scene,e,t,n)}spawnEnemy(e){const t=new kh(this.scene,this.physicsWorld,e,this.physicsMaterial);this.enemies.push(t)}spawnLargeEnemy(e){const t=new Sy(this.scene,this.physicsWorld,e,this.physicsMaterial);this.enemies.push(t)}update(e){this.portal&&this.portal.update(e)}checkPortalInteraction(e){return this.portal&&e.distanceTo(this.portal.mesh.position)<1.5&&this.portal.destination||null}}class Bl{constructor(e,t,n,i,s,r,a){b(this,"mesh");b(this,"body");b(this,"name");b(this,"position");b(this,"dialogue");b(this,"interactionCallback");this.name=i,this.position=s,this.dialogue=r,this.interactionCallback=a;const c=new Bt(1,2,1),l=new Xt({color:65280});this.mesh=new Ke(c,l),this.mesh.castShadow=!0,this.mesh.position.set(s.x,s.y+1,s.z),e.add(this.mesh);const h=new Lt(new y(.5,1,.5));this.body=new le({mass:0,position:new y(s.x,s.y+1,s.z),shape:h,material:n}),t.addBody(this.body)}isPlayerNearby(e){return e.distanceTo(new U(this.position.x,this.position.y,this.position.z))<2.5}getInteractionHint(){return`<span class="key-icon">ENTER</span> / <span class="btn-icon xbox-a">A</span> Talk to ${this.name}`}interact(){this.interactionCallback&&this.interactionCallback()}cleanup(e,t){e.remove(this.mesh),t.removeBody(this.body),this.mesh.geometry&&this.mesh.geometry.dispose();const n=this.mesh.material;n&&(Array.isArray(n)?n.forEach(i=>{i&&typeof i.dispose=="function"&&i.dispose()}):typeof n.dispose=="function"&&n.dispose())}}class Ty{constructor(e,t,n=65280){b(this,"mesh");b(this,"particles");b(this,"particleSystem");b(this,"color");b(this,"position");b(this,"positionVector");b(this,"isHealing",!1);b(this,"PARTICLE_COUNT",300);b(this,"RING_RADIUS",1);b(this,"PARTICLE_LIFETIME",1.5);b(this,"NORMAL_RISE_SPEED",.6);b(this,"HEALING_RISE_SPEED",1.8);b(this,"MAX_PARTICLE_SIZE",.5);b(this,"MAX_DELTA_TIME",.1);b(this,"HEALING_DURATION",2.5);b(this,"time",0);this.color=new we(n),this.position=t,this.positionVector=new U(t.x,t.y,t.z);const i=new Vr(this.RING_RADIUS,this.RING_RADIUS,.1,32),s=new gn({color:n,transparent:!0,opacity:.5});this.mesh=new Ke(i,s),this.mesh.position.set(t.x,t.y,t.z),e.add(this.mesh),this.particleSystem={positions:new Float32Array(this.PARTICLE_COUNT*3),velocities:new Float32Array(this.PARTICLE_COUNT*3),lifetimes:new Float32Array(this.PARTICLE_COUNT),sizes:new Float32Array(this.PARTICLE_COUNT),count:this.PARTICLE_COUNT};for(let c=0;c<this.PARTICLE_COUNT;c++)this.resetParticle(c,!0);const r=new Qt;r.setAttribute("position",new Et(this.particleSystem.positions,3)),r.setAttribute("size",new Et(this.particleSystem.sizes,1));const a=new qn({uniforms:{color:{value:this.color}},vertexShader:`
                attribute float size;
