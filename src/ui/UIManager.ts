...
import { StartMenu, StartMenuOption } from '../menus/StartMenu';
...
export class UIManager {
    ...
    registerPlayer(player: Player) {
        ...
        const pui = this.playerUiFactory.createPlayerUi(this.container, player);
    ...
    showStartMenu(
        ...
        this.startMenu = this.startMenuFactory.createStartMenu(
            this.startScreen,
            hasSave,
            (option) => {
