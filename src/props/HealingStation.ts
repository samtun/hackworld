...
import { createParticleShaderMaterial, updateParticleScaleFactor } from '../items/shader-utils/ParticleShaderUtils';
...
export class HealingStation extends ModelProp implements IHealingStation {
    ...
    constructor(
        ...
        this.healingSystem.register(this);
    }
    ...
    cleanup(scene: THREE.Scene): void {
        ...
        this.healingSystem.unregister(this);

        if (this.isHealing) {
            this.audioManager.stopHealingStationLoop();
    ...
    setHealing(isHealing: boolean): void {
        ...
        if (isHealing) {
            this.isHealing = true;
            this.audioManager.startHealingStationLoop();
        } else {
            this.isHealing = false;
            this.audioManager.stopHealingStationLoop();
        }
