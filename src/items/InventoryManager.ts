...
export class InventoryManager {
    ...
    private generateStatsHTML(player: Player): string {
        ...
        const swordTechColor = player.weaponTech[WeaponType.SWORD] == techCap ? cappedTechColor : defaultTechColor;
        const dualBladeTechColor = player.weaponTech[WeaponType.DUAL_BLADE] == techCap ? cappedTechColor : defaultTechColor;
        const lanceTechColor = player.weaponTech[WeaponType.LANCE] == techCap ? cappedTechColor : defaultTechColor;
        const hammerTechColor = player.weaponTech[WeaponType.HAMMER] == techCap ? cappedTechColor : defaultTechColor;
        const recoveryTechColor = player.skillTech[SkillTechType.RECOVERY] == techCap ? cappedTechColor : defaultTechColor;
        const blastTechColor = player.skillTech[SkillTechType.BLAST] == techCap ? cappedTechColor : defaultTechColor;
        const rangedTechColor = player.skillTech[SkillTechType.RANGED] == techCap ? cappedTechColor : defaultTechColor;
        const techHTML = `${sep}
            <div style="font-weight: bold;">Tech</div>${sep}
            <div style="display:grid; grid-template-columns:1fr 1fr; gap: 4px">
                <div style="display:flex; align-items:center; gap:4px;">${getWeaponIcon(WeaponType.SWORD)}<div><div style="font-size:13px; color:#aaa;">Sword</div><div style="color:${swordTechColor}">${player.weaponTech[WeaponType.SWORD]} | <span style="font-style:italic;color:#BBB;">${weaponLevelChar(player.weaponTech[WeaponType.SWORD])}</span></div></div></div>
                <div style="display:flex; align-items:center; gap:4px;">${getWeaponIcon(WeaponType.DUAL_BLADE)}<div><div style="font-size:13px; color:#aaa;">Double Sword</div><div style="color:${dualBladeTechColor}">${player.weaponTech[WeaponType.DUAL_BLADE]} | <span style="font-style:italic;color:#BBB;">${weaponLevelChar(player.weaponTech[WeaponType.DUAL_BLADE])}</span></div></div></div>
                <div style="display:flex; align-items:center; gap:4px;">${getWeaponIcon(WeaponType.LANCE)}<div><div style="font-size:13px; color:#aaa;">Lance</div><div style="color:${lanceTechColor}">${player.weaponTech[WeaponType.LANCE]} | <span style="font-style:italic;color:#BBB;">${weaponLevelChar(player.weaponTech[WeaponType.LANCE])}</span></div></div></div>
                <div style="display:flex; align-items:center; gap:4px;">${getWeaponIcon(WeaponType.HAMMER)}<div><div style="font-size:13px; color:#aaa;">Hammer</div><div style="color:${hammerTechColor}">${player.weaponTech[WeaponType.HAMMER]} | <span style="font-style:italic;color:#BBB;">${weaponLevelChar(player.weaponTech[WeaponType.HAMMER])}</span></div></div></div>
