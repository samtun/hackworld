...
- [ ] Code follows entity-based architecture principles
- [ ] New entities are in separate class files
- [ ] Code is maintainable and well-documented
- [ ] TypeScript types are properly defined
- [ ] Resources are properly cleaned up
- [ ] README.md is updated if needed (features, commands, setup, etc.)
- [ ] No console errors or warnings
- [ ] Code has been tested in development mode
